...
class RandomWalkEnemy(Enemy):
    ...
    def create(self) -> None:
        self.__id = self.canvas.create_rectangle(0, 0, 0, 0, outline=self.color, width=2)
    ...
    def update(self) -> None:
        ...
        # Move randomly within certain bounds
        delta_x = random.randint(1, 3) * self.__direction_x
        delta_y = random.randint(1, 3) * self.__direction_y
        self.x = max(0, min(self.game.screen_width, self.x + delta_x))
        self.y = max(0, min(self.game.screen_height, self.y + delta_y))
...
class EnemyGenerator:
    ...
    def create_enemy(self) -> None:
        ...
        random_walk_enemy = RandomWalkEnemy(self.__game, 20, "blue")
        # random_walk_enemy.x = 150
        # random_walk_enemy.y = 200
        self.game.add_enemy(random_walk_enemy)
